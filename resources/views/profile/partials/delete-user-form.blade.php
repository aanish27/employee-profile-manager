<section >
    <div class="d-flex align-baseline">
        ...
        <x-primary-button class="btn-danger d-inline h-25 ms-5 mt-4" type="button" data-bs-toggle="modal" data-bs-target="#deleteAccountModal">{{ __('Delete Account') }}</x-primary-button>
    </div>
