...
<div class="content w-100">
    ...
    <main class="container.fluid p-3" >
        ...
        <!-- Delete Modal -->
        <x-delete-modal module="Employee" message="This Action wil Delete Employee and the records related to him Such as Bank Account of the employee" />

        <div id="table-filters" class="row row-cols-auto gap-2 mt-4 ms-0">
            <x-dropdown-filter id="filter-position" modal="Position" :collections="$positions" feild="null" />
            <x-dropdown-filter id="filter-company" modal="Company" :collections="$companys" feild="name" />
