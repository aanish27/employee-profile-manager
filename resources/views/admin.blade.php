                    ...
                    columns: [
                        {
                            ...
                            render: function (data, type, row) {
                                return `  <button class="d-inline btn  btn-edit p-1 " id="btn-edit-${row.id}" data-id="${row.id}" data-bs-toggle="modal" data-bs-target=".modal" >
                                           ...
                                           <button class="btn btn-dlt-modal p-1 d-inline" data-id="${row.id}" data-bs-toggle="modal" data-bs-target="#deletConfirmation" >
